...
import com.example.offers.adapters.CartAdapter;
import com.example.offers.databinding.ActivityCheckoutBinding;
import com.example.offers.model.Product;
import com.example.offers.utils.Constants;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter= new CartAdapter(this, products, new CartAdapter.CartListener() {
            ...
            public void onQuantityChanged() {
                binding.subtotal.setText(String.format("kes %.2f",cart.getTotalPrice()));
        ...
        binding.total.setText("Kes" + totalPrice );
